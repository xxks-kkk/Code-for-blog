...
(define tests
  (test-suite
   ...
   (check-equal? (stream-for-n-steps nats 4) (list 1 2 3 4) "stream-for-n-steps test2")
   ...
   (check-equal? (stream-for-n-steps (stream-add-zero nats) 3) (list (cons 0 1) (cons 0 2) (cons 0 3)) "stream-add-zero test2")
