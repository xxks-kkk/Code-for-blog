...
We automate the whole process through a script \footnote{https://github.com/xxks-kkk/Code-for-blog/blob/filebench/2018/emmett/filebench/strace.sh}. The result is shown in Table \ref{result}.
...
We perform 20 pulls for the experiment \footnote{Code: https://github.com/xxks-kkk/Code-for-blog/tree/filebench/2018/emmett/filebench/benchmarks/git-benchmark}. The result is shown in Table \ref{result2}.
