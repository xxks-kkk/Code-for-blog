...
\begin{QandA}
   ...
   \item Somebody likes nobody.
         ...
         \begin{answered}
			...
			\Tree [. \node[label={right:{\textit{\footnotesize t \space $(\exists y)(person'(y) \& (\neg (\exists x)(person'(x) \& likes'(y,x))))$}}}]{$S \star$};
			  [.\node (dp1-o) {~}; ]
%			  [. \node[label={right:\textit{ \footnotesize $<<$e,t$>$,t$>$ \space $\lambda Q. (\exists y)(person'(y) \& Q(y))$}}]{$DP_2$}; 
%			    [.\node [label={below left: $<<$e,t$>$,$<<$e,t$>$,t$>>$ \space $\lambda P. \lambda Q. (\exists x)(P(x) \& Q(x))$}] {Det}; some ]
%			    [.\node [label={below left: $<$e,t$>$ \space $person'$}] {NP}; body ]
%			  ]
			     [.\node[label={right:\textit{\footnotesize $<$e,t$>$ \space $\lambda v_2. \neg (\exists x)(person'(x) \& likes'(x)(v_2))$}}]{}; 
			       [.2 ] 
			       [.\node[label={left:\textit{\footnotesize t \space $\neg (\exists x)(person'(x) \& likes'(x)(v_2))$}}]{$S$};
			         [.\node[label={left:\textit{\footnotesize $<<$e,t$>$,t$>$ \space $\lambda Q. \neg (\exists x)(person'(x) \& Q(x))$}}]{$DP_1$}; 
			           [.\node [label={below left: $<<$e,t$>$,$<<$e,t$>$,t$>>$ \space $\lambda P. \lambda Q. \neg (\exists x)(P(x) \& Q(x))$}] {Det}; no ]
			           [.\node [label={below left: $<$e,t$>$ \space $person'$}] {NP}; body ]
			         ]
			         [.\node[label={right:\textit{\footnotesize $<$e,t$>$ \space $\lambda v_1 . likes'(v_1)(v_2)$}}]{};
			           [.1 ]
			           [.\node[label={right:\textit{\footnotesize $t$ \space $likes'(v_1)(v_2)$}}]{S};
			             [.\node[label={right:\textit{\footnotesize $e$ \space $v_2$ }}]{$t_2$};]
			             [.\node[label={left:\textit{\footnotesize $<$e,t$>$ \space $likes'(v_1)$ }}]{VP};
			               [.\node[label={below left:\textit{\footnotesize $<$e, $<$e,t$>$$>$} \space $likes'$}]{$V_{tr}$}; likes ]
			               [.\node[label={below left:\textit{\footnotesize $e$ \space $v_1$ }}]{$t_1$};]
			             ]
			           ]
			         ]
			       ]
			...
			\begin{scope}[shift=({-1cm, -10cm})]
			\Tree [. \node (dp1)[label={left:\textit{ \footnotesize $<<$e,t$>$,t$>$ \space $\lambda Q. (\exists y)(person'(y) \& Q(y))$}}]{$DP_2$}; 
		      [.\node [label={below left: $<<$e,t$>$,$<<$e,t$>$,t$>>$ \space $\lambda P. \lambda Q. (\exists x)(P(x) \& Q(x))$}] {Det}; some ]
		      [.\node [label={below left: $<$e,t$>$ \space $person'$}] {NP}; body ]
			]
			\end{scope}  
   ...
   \item Every sensible person who likes Mozart likes Haydn.
		...
		\Tree [.\node [label={right: $t$ \space $(\forall x)((sensible'(x) \& person'(x) \& likes'(m)(x)) \rightarrow likes'(h)(x))$}] {S $\ast$};
		        [.\node(site){$DP_3 \star$}; ]
		...
		\begin{tikzpicture}[scale=0.8]
		\begin{scope}
		\Tree [.\node [label={left: $<<$e,t$>$,t$>$ \space $\lambda Q. (\forall x)((sensible'(x) \& person'(x) \& likes'(m)(x)) \rightarrow Q(x))$ }] {$DP_3 \star$}; 
		        [.\node [label={below left: $<<$e,t$>$,$<<$e,t$>$,t$>>$ \space $\lambda P. \lambda Q. (\forall x)(P(x) \rightarrow Q(x))$ }] {DP}; every ]
		        [.\node (empty) {~};		          
...
%		          ]
        ...
        \Tree [.\node (root) [label={left: $<$e,t$>$ \space $\lambda y. (sensible'(y) \& person'(y) \& likes'(m)(y))$}] {NP $\delta$};
        		            [.\node [label={left: $<$e,t$>$ \space $\lambda x. (sensible'(x) \& person'(x))$}] {NP};
        		              [.\node [label={below left: $<<$e,t$>$,$<$e,t$>>$ \space $\lambda P. \lambda x. (P(x) \& sensible'(x))$}] {AP}; sensible ]
        		              [.\node [label={below left: $<$e,t$>$ \space $person'$}] {NP}; person ]
        		            ]
        		            [.\node [label={right: $<$e,t$>$ \space $\lambda v_2. likes'(m)(v_2)$}] {RC}; 
        		              [.COMP $who_2$ ]
        		              [.\node [label={right: $<$t$>$ \space $likes'(m)(v_2)$}] {S};
   ...
   \item An American farmer talked to a Canadian farmer. (Treat ‘talk to’ as a transitive verb.)
       ...
       \Tree [.\node (dp2) [label={right: $<<$e,t$>$,t$>$ \space $\lambda Q. (\exists x)(American'(x) \& farmer'(x) \& Q(x))$}] {$DP_2$}; 
        ...
        \end{answered}
   \item Not everybody who likes somebody likes everybody. (N.B. In (5) treat `not everybody' as consisting of the complex determiner `not every' and the noun `body'. Treat `not every' as an unanalyzed determiner with the semantics:
   $\lambda P. \lambda Q. \neg (\forall x)(P(x)\rightarrow Q(x))$) and treat `body' as an NP to which the relative clause `who likes somebody' can be adjoined.)
         \begin{answered}
         \begin{tikzpicture}[scale=1]
   			\tikzset{level 1+/.style={level distance=30pt}}
   			\tikzset{every tree node/.style={align=left,anchor=north}}
         ...
         \Tree [.\node [label={right: $t$ \space $\neg (\forall y)((\exists x) (person'(x) \& likes'(y,x)) \rightarrow (\forall z)(person'(z) \rightarrow likes'(y,z)))$}] {S $\star$}; 
                 [.\node(dp2-o) {$DP_2$}; ]
                 [.\node [label={right: $<$e,t$>$ \space $\lambda v_2. (\forall x)(person'(x) \rightarrow likes'(x)(v_2))$}] {};
                   [.2 ]
                   [.\node [label={right: $t$ \space $(\forall x)(person'(x) \rightarrow likes'(x)(v_2))$}] {S};
                     [.\node [label={left: $<<$e,t$>$,t$>$ \space $\lambda Q. (\forall x)(person'(x)\rightarrow Q(x))$}] {$DP_1$};  
                       [.\node [label={below left: $<<$e,t$>$, $<<$e,t$>$,t$>>$ \space $\lambda P. \lambda Q. (\forall x)(P(x) \rightarrow Q(x))$}] {Det}; every ]
                       [.\node [label={below right: $<$e,t$>$ \space $person'$}] {NP}; body ]
                     ]
                     [.\node [label={right: $<$e,t$>$ \space $\lambda v_1. likes'(v_1)(v_2)$}] {};
                       [.1 ]
                       [.\node [label={right: $t$ \space $likes'(v_1)(v_2)$}] {S}; 
         ...
         \begin{scope}[shift=({1cm, -8cm}), scale=0.8]
         \Tree [.\node (dp2) [label={left: $<<$e,t$>$,t$>$ \space $\lambda Q. \neg (\forall y)((\exists x) (person'(x) \& likes'(x)(y)) \rightarrow Q(y))$}] {$DP_2$}; 
                 [.\node [label={below left: $<<$e,t$>$, $<<$e,t$>$,t$>>$ \space $\lambda P. \lambda Q. \neg (\forall y)(P(y)\rightarrow Q(y))$}] {Det}; {not every} ]
                 [.\node [label={right: $<$e,t$>$ \space $\lambda v_4. (\exists x) (person'(x) \& likes'(x)(v_4))$}] {RC}; 
                   [.\node {Comp}; $who_4$ ] 
                   [.\node [label={right: $t$ \space $(\exists x) (person'(x) \& likes'(x)(v_4))$}] {S}; 
                       [.\node [label={right: $<<$e,t$>$,t$>$ \space $\lambda Q. (\exists x) (person'(x) \& Q(x))$}] {$DP_3$}; 
                         [.\node [label={below left: $<<$e,t$>$, $<<$e,t$>$,t$>>$ \space $\lambda P. \lambda Q. (\exists x)(P(x) \& Q(x))$}] {Det}; some ]
                         [.\node [label={below right: $<$e,t$>$ \space $person'$}] {NP}; body ]
                       ]
         ...
         \end{scope}
         \draw[semithick,->] (dp2) to [out=140, in=180] (dp2-o);
         \end{tikzpicture}
         
         \begin{align*}
       	 \star & =(\lambda Q. \neg (\forall y)((\exists x) (person'(x) \& likes'(x)(y)) \rightarrow Q(y)))(\lambda v_2. (\forall z)(person'(z) \rightarrow likes'(z)(v_2))) \\
       	 & =  \neg (\forall y)((\exists x) (person'(x) \& likes'(x)(y)) \rightarrow (\forall z)(person'(z) \rightarrow likes'(z)(y)))\\
       	 & = \neg (\forall y)((\exists x) (person'(x) \& likes'(y,x)) \rightarrow (\forall z)(person'(z) \rightarrow likes'(y,z)))
       	 \end{align*}
         \end{answered}
\end{QandA}