...
public class Ngrams {
    ...
    public Ngrams() {
        ...
        unigramMap.put(end_symbol, new DoubleValue());
     ...
     */
    public void train(List<List<String>> sentences, String start_marker, String end_marker) {
        // Accumulate unigram and bigram counts in maps
        trainSentences(sentences, start_marker, end_marker);
     ...
     */
    public void trainSentences(List<List<String>> sentences, String start_marker, String end_marker) {
        for (List<String> sentence : sentences) {
            trainSentence(sentence, start_marker, end_marker);
        }
    }
     ...
     */
    public void test(List<List<String>> sentences, String start_marker, String end_marker) {
        ...
        for (List<String> sentence : sentences) {
            ...
            double sentenceLogProb = sentenceLogProb(sentence, start_marker, end_marker);
     ...
     */
    public void test2(List<List<String>> sentences, String start_marker) {
        double totalLogProb = 0;
        double totalNumTokens = 0;
        for (List<String> sentence : sentences) {
            totalNumTokens += sentence.size();
            double sentenceLogProb = sentenceLogProb2(sentence, start_marker);
            //	    System.out.println(sentenceLogProb + " : " + sentence);
            totalLogProb += sentenceLogProb;
        }
        double perplexity = Math.exp(-totalLogProb / totalNumTokens);
